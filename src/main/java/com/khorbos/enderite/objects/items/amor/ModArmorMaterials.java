package com.khorbos.enderite.objects.items.amor;
...
public enum ModArmorMaterials implements ArmorMaterial {
    ENDERITE("enderite", 41, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0F, 0.2F, () -> {
        return Ingredient.ofItems(ItemRegistries.ENDERITE_INGOT);
    });
